...
use debug_render::{DebugRenderPipelineResource, RapierDebugRenderPlugin};
use rapier_testbed3d::physics::{DeserializedPhysicsSnapshot, PhysicsEvents, PhysicsSnapshot, PhysicsState};
...
use camera3d::{OrbitCamera, OrbitCameraPlugin};
use graphics::BevyMaterial;
// use bevy::render::render_resource::RenderPipelineDescriptor;

const RAPIER_BACKEND: usize = 0;
const PHYSX_BACKEND_PATCH_FRICTION: usize = 1;
const PHYSX_BACKEND_TWO_FRICTION_DIR: usize = 2;
...
fn draw_contacts(_nf: &NarrowPhase, _colliders: &ColliderSet) {
    ...
    //
    //             use rapier_testbed3d::engine::GraphicsWindow;
...
use mouse::{track_mouse_state, MainCamera, SceneMouse};
