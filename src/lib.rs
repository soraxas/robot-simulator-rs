...
pub(crate) use system_set::SystemSet;
...
/// - [`r#mod::plugin`]: Handles the physics of entities.
...
/// - [`lib::plugin`]: Handles the loading and saving of games.
...
impl Plugin for SimPlugin {
    fn build(&self, app: &mut App) {
        app
            .add_plugins(            bevy_config::plugin)
            .init_state::<AppState>()
