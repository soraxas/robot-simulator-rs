use crate::{file_system_interaction::config::GameConfig, AppState};
...
pub(super) fn plugin(app: &mut App) {
    app.add_plugins(TomlAssetPlugin::<GameConfig>::new(&["game.toml"]))
        .add_plugins(ProgressPlugin::new(AppState::Loading).continue_to(AppState::Menu))
        .add_loading_state(
        ...
        // .add_systems(Update, show_progress.run_if(in_state(AppState::Loading)))
